  ...
  var responsiveNav = function (el, options) {
    ...
    ResponsiveNav.prototype = {
      ...
      _calcHeight: function () {
        ...
        var innerStyles = "." + opts.jsClass + " ." + opts.navClass + "-" + this.index + ".opened{max-height:" + savedHeight + "px} ." + opts.jsClass + " .disable-pointer-events{pointer-events:none} ." + opts.jsClass + " ." + opts.navClass + "-" + this.index + ".opened.dropdown-active {max-height:9999px}";
